        ...
        <div class="pt-4 border-t border-slate-800/80 flex flex-wrap items-center justify-between gap-3">
            ...
            <div class="flex flex-wrap items-center gap-2.5">
                @can('manageMinutes', $agenda)
                    <a 
                        href="{{ route('admin.agendas.notulen', $agenda) }}" 
                        class="inline-flex items-center gap-2 px-3.5 py-2.5 rounded-lg text-xs font-bold text-slate-950 bg-amber-300 hover:bg-amber-400 transition shadow-sm"
                        title="Buka Pengolah Kata untuk menyusun notulensi dan menyesuaikan format dokumen"
                    >
                        ...
                        <span>Notulensi &amp; Format Dokumen</span>
                    </a>
                @endcan
                ...
                <div class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-slate-700 font-medium leading-relaxed pl-7">
                            ...
                            @endif
                            Rekapitulasi berita acara ini disusun dan diverifikasi sebagai bukti sah pelaksanaan kegiatan kedinasan.
                        </p>
                    </div>
                </div>
