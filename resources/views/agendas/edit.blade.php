                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="field">
                        ...
                        <select id="tipe_rapat" name="tipe_rapat" class="input w-full @error('tipe_rapat') input-error @enderror" onchange="toggleFormatFields(this.value)" required>
                            <option value="offline" {{ old('tipe_rapat', $agenda->tipe_rapat) === 'offline' ? 'selected' : '' }}>Tatap Muka (Offline)</option>
                            <option value="online" {{ old('tipe_rapat', $agenda->tipe_rapat) === 'online' ? 'selected' : '' }}>Daring (Online Meeting)</option>
                            <option value="hybrid" {{ old('tipe_rapat', $agenda->tipe_rapat) === 'hybrid' ? 'selected' : '' }}>Hybrid (Tatap Muka & Daring)</option>
                        </select>
                        @error('tipe_rapat')
                            <p class="text-xs text-rose-600 mt-1">{{ $message }}</p>
                        @enderror
