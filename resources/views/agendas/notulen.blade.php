        ...
        <div class="panel p-5 space-y-3">
            ...
            <div class="space-y-2 text-xs font-medium text-slate-800">
                ...
                <div>
                    ...
                    <span class="font-mono font-bold text-slate-950">{{ $agenda->waktu_mulai->translatedFormat('d M Y, H:i') }} {{ $agenda->waktu_selesai ? '- ' . $agenda->waktu_selesai->format('H:i') . ' WIB' : 'WIB s.d. Selesai' }}</span>
                </div>
                <div>
