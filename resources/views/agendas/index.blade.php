...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div class="bg-white rounded-2xl border border-slate-300 shadow-xs hover:border-slate-400 transition flex flex-col justify-between overflow-hidden">
                <div>
                    ...
                    <div class="p-5 space-y-3">
                        <h3 class="font-bold text-slate-900 text-base leading-snug hover:text-blue-900 transition">
        ...
        @empty
            <div class="col-span-full py-12 text-center bg-white rounded-2xl border border-slate-300 p-8">
                <svg class="mx-auto text-slate-400 mb-3" viewBox="0 0 24 24" width="48" height="48" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>
                <h4 class="text-sm font-bold text-slate-800">Tidak Ada Agenda Rapat</h4>
                <p class="text-xs text-slate-600 mt-1 font-medium">Belum ada agenda rapat yang sesuai dengan filter yang dipilih.</p>
            </div>
        @endforelse
    </div>
