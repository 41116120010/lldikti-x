        ...
        <form method="POST" action="{{ route('admin.users.update', $user) }}" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div class="field">
                    ...
                    @else
                        <input type="text" class="input w-full bg-slate-100 text-slate-500" value="{{ $user->unit?->nama_unit }}" readonly disabled>
                ...
                <div class="field md:col-span-2">
                    ...
                    >
                    <p class="text-[11px] text-slate-400 mt-1">Kosongkan jika tidak ada perubahan kata sandi.</p>
                    @error('password')
                        <p class="text-xs text-rose-600 mt-1">{{ $message }}</p>
                    @enderror
                </div>
