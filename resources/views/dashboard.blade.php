...
<div class="space-y-6">
    ...
    <!-- Active Agendas Section (Full Width & Focused) -->
    <div class="space-y-4">
        <div class="panel flex flex-col justify-between">
            <div>
                <div class="toolbar">
                    ...
                    <span class="text-xs text-slate-600 font-medium">Menampilkan agenda rapat dinas aktif dan terjadwal terdekat</span>
                </div>
